 ...
 */
public class Battery extends Report implements UpdateListener{
	...
	public void done() {
		...
		write("Hosts Mean Energy Consume/s: " + geralMeanAllPeriodsConsume/hostsSize);
		write("Hosts Mean normal Energy Consume/s: "+geralMeanNormalPeriodConsume/hostsSize);
		write("Hosts Mean Selfish Period Consume/s: "+ geralMeanEgoistPeriodConsume/hostsSize);
		write("");
		write("Hosts Mean Energy Consume: "+ geralallPeriodsConsume/hostsSize);
		write("Hosts Mean Normal Energy Consume: "+ geralNormalPeridConsume/hostsSize);
		write("Hosts Mean Selfish Energy Consume: "+ geralEgoistPeridConsume/hostsSize);
		write("");
