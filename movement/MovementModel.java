...
public abstract class MovementModel {
	...
	public static List<Tuple<String, Coord>> protoInitLocations = new ArrayList<Tuple<String, Coord>>();
	public static String groupStaticNumber;
	 ...
	 */
	//--------------------------------------
	public LabelList getLabel(DTNHost host) {System.out.println("NAO ERA PRA PRINTAR"); return new LabelList();}
	//--------------------------------------
	...
	public String showHostMap() {System.out.println("NAO ERA PRA PRINTAR O MAP AQUI");return "BBUGOU";}
	public void setHostMap(DTNHost dtnHost) {System.out.println("NAO ERA PRA ADICIONAR NO MAP AQUI");}
